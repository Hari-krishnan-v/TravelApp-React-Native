...
const TripDetail = () => {
    ...
    const renderTabBar = (props: any) => (
        <View style={styles.tabBarContainer}>
            ...
            <View
                style={[styles.divider, {transform: [{translateX: index === 0 ? 0 : index === 1 ? 120 : index === 2 ? 240 : index === 3 ? 350 : 0}],}]}/>
        </View>
    );
    ...
    return (
        <View style={styles.container}>
            ...
            <Animated.View entering={FlipInXDown.duration(400).easing(Easing.inOut(Easing.quad))}
            ...
            <View style={styles.subContainer}>
                ...
                <Pressable style={styles.button}>
                    <Text style={{textAlign: 'center', fontFamily: 'Poppins-Bold', color: 'white', fontSize: 18}}>Save a
                        Trip </Text>
                </Pressable>
            </View>
        </View>
...
const styles = StyleSheet.create({
    ...
    divider: {
        height: 2,
        width: 100,
        backgroundColor: '#F36D72', // Change color as needed
        position: 'absolute',
        bottom: 0, // Position the divider at the bottom of the tab bar
        left: 0,
        right: 0,
    },
